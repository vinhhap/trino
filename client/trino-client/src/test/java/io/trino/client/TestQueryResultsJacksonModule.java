...
class TestQueryResultsJacksonModule
{
    private static final TrinoJsonCodec<QueryResults> DEFAULT_CODEC = jsonCodec(QueryResults.class);
    private static final TrinoJsonCodec<QueryResults> EAGER_CODEC = jsonCodec(QueryResults.class, new QueryResultsJacksonModule(false));
